  ...
  return <footer className="bg-primary text-primary-foreground py-12">
      <div className="container mx-auto px-6 md:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <img src="/lovable-uploads/0fac1cf9-825c-49b7-948d-924dcdbce49f.png" alt="Cronologis" className="h-10 mb-4" />
          ...
          <div>
            ...
            <p className="text-primary-foreground/80 text-sm">+56999497832</p>
          </div>

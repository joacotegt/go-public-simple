...
export function ProcessDemo() {
  ...
  const progressWidth = useTransform(scrollYProgress, [0.25, 0.85, 0.95], [0, 100, 100]);
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-6">
            ...
            // Mantener completamente visible después del 85%
            const stepOpacity = useTransform(scrollYProgress, [step.triggerPoint - 0.12, step.triggerPoint, 0.85], [0, 1, 1]);
            const stepX = useTransform(scrollYProgress, [step.triggerPoint - 0.12, step.triggerPoint, 0.85], [-50, 0, 0]);
            const isActive = useTransform(scrollYProgress, [step.triggerPoint - 0.08, step.triggerPoint, 0.85], [0, 1, 1]);
            const isCurrent = useTransform(scrollYProgress, [step.triggerPoint - 0.08, step.triggerPoint, step.triggerPoint + 0.12, 0.85], [0, 1, 0, 0]);
